% =============================================================================
% §2 Background and Literature Review  --  budget ~13 pp
% rubric: Introduction & Literature Review /20
%
% This section now carries the PIHM framework of Wu et al. as PRIOR ART, on the
% same footing as GQSP.  §2.4.3 is where the published collocation encoding is
% judged; that critical assessment is the pivot into §3 and is the explicit HD
% gate in the mark sheet.
% =============================================================================
...
% descriptor claim is made in §3.  Marker checklist: antecedent before contribution.
...
% PRIOR ART -- Wu et al. (2025).  Present at the same depth as GQSP below.
% Everything in this subsection is attributed, not claimed.

\subsubsection{The Residual Construction and Its Ground State}

\subsubsection{The Published collocation Encoding}

\subsubsection{Critical Assessment: The Encoding Wall}
...
% Assert the structural diagnosis here; the MEASURED evidence for it is §5.2.
...
% implements no measurement protocol (see §3.9 and §6.5).
