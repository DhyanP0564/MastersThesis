...
% Per-atom residuals, composition-algebra tests, the tolerances quoted in §3.10.
...
% Every case solved, with parameters and status.  Referenced from §5.5--§5.7.

\section{Readout Protocols and Their Costs}
% Candidate protocols and sample costs quoted from the literature.
% Referenced from §3.9.  Nothing here was implemented in this work.
